...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="/ad/index">首页</a> &raquo;  <a href="/ad/storageRoom">库房管理</a> &raquo; <a href="/ad/storageRoom">库管列表</a> &raquo;  货架列表
</div>
<!--面包屑导航 结束-->
        ...
        <div class="result_content">
            <table class="list_tab">
                ...
                <tr >
                    ...
                    {{--</td>--}}
                    <td class="tc" id="did">{{$goodsShelve->id}}</td>
                    <td>{{$goodsShelve->shelf_name}}</td>
                    <td>{{$goodsShelve->created_at}}</td>
                    <td>{{$goodsShelve->updated_at}}</td>
                    <td>
                        <a href="/ad/goodsShelve/{{$goodsShelve->id}}/edit">货架列表</a>
