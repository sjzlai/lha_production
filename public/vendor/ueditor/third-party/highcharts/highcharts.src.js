 ...
 * call stack size exceeded errors in Chrome when trying to apply more than 150.000 points. This
...
/**
 * Provide errors messages for debugging, with links to online explanation 
 */
function error(code, stop) {
	var msg = 'Highcharts errors #' + code + ': www.highcharts.com/errors/' + code;
	if (stop) {
		throw msg;
	} else if (win.console) {
		console.log(msg);
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		// Display an errors if the renderTo is wrong
		if (!renderTo) {
			error(13, true);
		}
