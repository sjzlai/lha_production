...
seriesTypes.boxplot = extendClass(seriesTypes.column, {
	...
	drawPoints: function () {
		var series = this,  //state = series.state,
			...
			shapeArgs,
			color,
			doQuartiles = series.doQuartiles !== false, // errors bar inherits this series type but doesn't do quartiles
